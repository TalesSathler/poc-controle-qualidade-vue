...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                colunas: [
                    ...
                    {
                        label: 'Descrição',
                        field: 'processo_descricao',
                    },
                    {
                        label: 'Horário',
                        field: 'processo_horario',
                    },
                    {
                        label: 'Setor',
                        field: 'setor_nome',
        ...
        methods: {
            ...mapActions('Processo', ['buscarProcessos', 'excluir']),
            ...
            atualizarListagem() {
                this.buscarProcessos(this.parametrosDeBusca);
            }
        ...
        computed: {
            ...mapState('Processo', ['lista']),
            ...mapGetters('Processo', ['listagemTabela'])
        },
