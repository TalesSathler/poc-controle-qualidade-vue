...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions('Setor', ['buscarSetores', 'excluir']),
            ...
            remover(item) {
                this.$swal({
                    title: 'Deseja realmente remover o setor?',
            ...
            atualizarListagem() {
                this.buscarSetores(this.parametrosDeBusca);
            }
        ...
        computed: {
            ...mapState('Setor', ['lista']),
            ...mapGetters('Setor', ['listagemTabela'])
        },
